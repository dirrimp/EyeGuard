...
check("session_watcher checks for an attached debugger via the kernel's own P_TRACED flag",
      "_is_debugger_attached" in session_watcher_src
      and "_P_TRACED" in session_watcher_src)
